  ...
  return (
    <Container>
      <div id="certificates" className="md:px-28 md:py-20 lg:py-28 p-5">
        <h1 className="text-3xl font-bold mb-5">Awards &amp; Certifications</h1>
        <div className="flex gap-4 flex-col flex-wrap md:flex-row">
          <Card className="w-full md:max-w-[400px] lg:1/4 bg-primary-100">
            <CardHeader>
              <h3 className="text-center font-bold text-white text-lg">JavaScript Algorithms &amp; Data Structures</h3>
            </CardHeader>
            <CardBody>
          ...
          <Card className="w-full md:max-w-[400px] lg:1/4 bg-primary-100">
            <CardHeader>
              <h3 className="text-center text-white font-bold text-lg">Back End Development &amp; APIs</h3>
            </CardHeader>
            <CardBody>
