...
export default function HomeSection() {
  return (
    <Container>
      <div className="md:px-28 md:py-20 lg:py-28 lg:w-4/5 px-10 py-10 w-full">
        <h5 className="font-semibold text-warning">Hey! my name is</h5>
        <h1 className="font-bold my-3 text-5xl md:text-6xl text-success">CYUSA Alain Tresor.</h1>
        ...
        <div className="action-buttons mt-10 space-x-5">
          <Button color="primary" className="text-white bg-success-300" variant="shadow">Contact</Button>
