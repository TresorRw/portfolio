...
export default function HomeSection() {
  return (
    <Container>
      <div className="md:px-28 md:py-24 lg:w-4/5 px-10 py-14 w-full">
        ...
        <p className="text-slate-200 text-justify text-lg">Passionate and skilled software developer with a proven track record of crafting robust and innovative solutions, eager to contribute expertise in different technologies to drive excellence in software development. Ready to bring a dynamic blend of technical proficiency and creativity to your team.</p>
